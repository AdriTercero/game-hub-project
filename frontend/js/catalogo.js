/* ── Game data ─────────────────────────────────────── */
    const GAMES = [
      { rank:1,  name:'Juego 1',  genre:'Acción',    year:2024, platform:['pc','ps5'],    press:9.8, community:9.6, coverClass:'gc1' },
      { rank:2,  name:'Juego 2',  genre:'RPG',       year:2024, platform:['pc','xbox'],   press:9.7, community:9.5, coverClass:'gc2' },
      { rank:3,  name:'Juego 3',  genre:'Estrategia',year:2023, platform:['pc'],          press:9.6, community:9.4, coverClass:'gc3' },
      { rank:4,  name:'Juego 4',  genre:'Acción',    year:2024, platform:['ps5','xbox'],  press:9.5, community:9.3, coverClass:'gc4' },
      { rank:5,  name:'Juego 5',  genre:'Indie',     year:2022, platform:['pc','switch'], press:9.4, community:9.2, coverClass:'gc5' },
      { rank:6,  name:'Juego 6',  genre:'RPG',       year:2023, platform:['ps5'],         press:9.3, community:9.1, coverClass:'gc6' },
      { rank:7,  name:'Juego 7',  genre:'Acción',    year:2022, platform:['pc','ps5'],    press:9.2, community:9.0, coverClass:'gc7' },
      { rank:8,  name:'Juego 8',  genre:'Estrategia',year:2024, platform:['pc'],          press:9.1, community:8.9, coverClass:'gc8' },
      { rank:9,  name:'Juego 9',  genre:'Indie',     year:2023, platform:['switch'],      press:9.0, community:8.8, coverClass:'gc9' },
    ];
    ...
    function getFiltered() {
      return GAMES.filter(g => {
        ...
        switch (sortKey) {
          case 'press':     return b.press - a.press;
          case 'community': return b.community - a.community;
