    ...
    /* Fake credential check — replace with real API call */
    function checkCredentials(email, password) {
        // Demo: only "demo@gamehub.io" / "Demo1234" succeeds
        return email === 'demo@gamehub.io' && password === 'Demo1234';
    }

    form.addEventListener('submit', (e) => {
        e.preventDefault();

        // Re-check lockout on submit (race condition guard)
